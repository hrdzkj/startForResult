...
/**
 * Created by LiuYi on 2019/1/2.
 */
public class StartForResultFragmentActivityImp extends Fragment implements IStartForResult.IStartForResultWithCallback  {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        //callback方式的处理
        IStartForResult.ICallback callback = mCallbacks.remove(requestCode);
        if (callback != null) {
